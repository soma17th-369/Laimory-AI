...
| User Memory 갱신 계약 | 접수 schema의 느슨함, digest 잘라내기, 재요청 상한, **결과 저장 1회** 수렴, `diaries` 마스킹 | user memory limits/repair/runner, endpoint, client, redaction 테스트 | HTTP API, App Server 계약, 데이터, 관측성, 제약 |
